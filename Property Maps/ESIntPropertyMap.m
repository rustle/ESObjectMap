...
#import "ESIntPropertyMap.h"

@implementation ESIntPropertyMap
@synthesize intTransformBlock=_intTransformBlock;
...
{
	return [[[self class] alloc] initWithInputKey:inputKey outputKey:outputKey intTransformBlock:intTransformBlock];
}
...
- (id)initWithInputKey:(NSString *)inputKey outputKey:(NSString *)outputKey intTransformBlock:(ESIntTransformBlock)intTransformBlock
{
	...
	if (self)
	{
		self.intTransformBlock = intTransformBlock;
	}
	return self;
}
