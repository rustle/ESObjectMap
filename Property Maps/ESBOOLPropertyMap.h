...
typedef BOOL (^ESBOOLTransformBlock)(id inputValue);

@interface ESBOOLPropertyMap : ESPropertyMap

@property (copy, nonatomic) ESBOOLTransformBlock boolTransformBlock;
