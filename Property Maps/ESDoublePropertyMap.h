...
typedef double (^ESDoubleTransformBlock)(id inputValue);

@interface ESDoublePropertyMap : ESPropertyMap
...
@property (copy, nonatomic) ESDoubleTransformBlock doubleTransformBlock;
